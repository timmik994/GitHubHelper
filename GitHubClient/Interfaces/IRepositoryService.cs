namespace GitHubClient.Interfaces
{
    ...
    public interface IRepositoryService
    {
        ...
        Task<ClientResponce<IEnumerable<BasicRepositoryData>>> GetUserRepositories(string username);
        ...
        Task<ClientResponce<IEnumerable<BasicRepositoryData>>> GetUserRepositories(BasicUserData userData);
        ...
        Task<ClientResponce<FullRepositoryData>> GetFullRepositoryData(BasicRepositoryData repositoryData);
    }
}
